...
The \emph{group lasso estimator} is a solution to the following penalized
least-squares convex optimization problem
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{equation}
\begin{aligned}
\label{eq:gsoln}
...
\end{equation}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
In the LASSO setting this is explicitly computable by
\begin{equation}
\label{eq:lammax}
...
$\eta_{g^*} = X_{g^*}^Ty / \|X_{g^*}^Ty\|_2$ is the unit vector that achieves $\|X_{g^*}^Ty\|_2$.
