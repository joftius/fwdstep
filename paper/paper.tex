...
that can also be used to calculate it in practice. However, in this
section we describe an alternative derivation following the discussion of
group LASSO in \cite{tests:adaptive}. The implementation described here
