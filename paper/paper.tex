...
\author{\fnms{Joshua} \snm{Loftus}
\and \fnms{Jonathan} \snm{Taylor}\corref{Jonathan E. Taylor}\ead[label=e1]{jonathan.taylor@stanford.edu}\thanksref{t1}}
...
\label{fig:fscat}
\includegraphics[width=0.6\textwidth]{../figs/tpr_default_categorical_nsim100_n100_p400_g200_sizes2-2_k24_lower2_upper4.pdf}}
\hspace{-15pt}
\subfigure[Gaussian designs]{
\label{fig:fsgauss}
\includegraphics[width=0.6\textwidth]{../figs/tpr_default_gaussian_nsim200_n100_p200_g200_k25_lower1pt5_upper2.pdf}}
\caption{\small \em
...
\label{fig:gausscorr}
\includegraphics[width=0.6\textwidth]{../figs/default_gaussian_nsim400_n100_p200_g200_k10_lower1pt5_upper2_corr0pt2_noisecorr0pt1.pdf}}
\hspace{-15pt}
\subfigure[Gaussian with groups]{
\label{fig:gaussgroups}
\includegraphics[width=0.6\textwidth]{../figs/default_gaussian_nsim400_n100_p200_g35_sizes5-10_k5_lower2_upper3.pdf}}
\caption{\small \em
...
\label{fig:hivnrti}
\includegraphics[width=0.6\textwidth]{../figs/default_fixed_nsim400_n848_p537_g82_sizes2-24_k5_lower4_upper8.pdf}}
\hspace{-15pt}
\subfigure[Simulated categorical design]{
\label{fig:gausscat}
\includegraphics[width=0.6\textwidth]{../figs/default_categorical_nsim500_n100_p80_g40_sizes2-2_k10_lower2_upper4.pdf}}
\caption{\small \em
...
\begin{figure}[!htp]
\begin{center}
\subfigure[Power of forward stepwise with spline groups]{
\label{fig:spline:fwd}
\includegraphics[width=0.6\textwidth]{../figs/tpr_gamsel_uniform_nsim100_n100_p200_g200_k18_k01_lower5_upper10.pdf}}
\hspace{-15pt}
\subfigure[$T\chi$ $p$-values with spline groups]{
\label{fig:spline:pval}
\includegraphics[width=0.6\textwidth]{../figs/gamsel_uniform_nsim200_n200_p50_g50_k6_k02_lower5_upper10.pdf}}
...
\begin{figure}[!htp]
\begin{center}
\subfigure[Power of FS-\textsc{glinternet} procedure]{
\label{fig:glint:fwd}
\includegraphics[width=0.6\textwidth]{../figs/tpr_glint_categorical_nsim100_n100_p72_g36_sizes2-2_k15_k01_lower5_upper10.pdf}}
\hspace{-15pt}
\subfigure[$T\chi$ $p$-values with FS-\textsc{glinternet}]{
\label{fig:glint:pval}
\includegraphics[width=0.6\textwidth]{../figs/glint_gaussian_nsim200_n100_p30_g30_k6_k02_lower5_upper10.pdf}}
\caption{\small \it The first panel shows the power of forward stepwise
...
\begin{figure}[!htp]
\begin{center}
\includegraphics[width=0.95\textwidth]{../figs/HIV_PI_plot.pdf}
...
\begin{figure}[!htp]
\begin{center}
\includegraphics[width=0.95\textwidth]{../figs/HIV_NRTI_plot.pdf}
...
\begin{figure}[!htp]
\begin{center}
\includegraphics[width=0.95\textwidth]{../figs/HIV_PI_glint_plot.pdf}
...
\begin{figure}[!htp]
\begin{center}
\includegraphics[width=0.95\textwidth]{../figs/HIV_NRTI_glint_plot.pdf}
