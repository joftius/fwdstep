...
the right hand side of \cite{test:exact}. The test statistic is presented as an example
...
\begin{figure}
\begin{center}
\resizebox{!}{3in}{\input{curved.pdf_tex}}
\end{center}
Selection conditioned on an arbitrary selection event.
\end{figure}
