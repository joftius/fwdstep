...
%For the rest of this section we drop the tilde and denote the expanded design matrix as $X$.
...
satisfy the hierarchy condition. To achieve a small computational speed-up, we first modify Algorithm~\ref{algo:fs} to keep track of which main effects have already been included. This reduces the search among potential variables.
